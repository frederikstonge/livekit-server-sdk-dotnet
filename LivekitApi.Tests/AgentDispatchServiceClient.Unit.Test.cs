...
/// <summary>
/// Unit tests for AgentDispatchServiceClient that don't require the Aspire infrastructure.
/// </summary>
public class AgentDispatchServiceClientUnitTest
{
    [Fact]
    public async Task Constructor_UsesCustomHttpClient_HeaderIsSent()
    {
        ...
        var service = new AgentDispatchServiceClient(
            "http://localhost",
            "key",
