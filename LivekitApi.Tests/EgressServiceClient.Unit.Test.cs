...
/// <summary>
/// Unit tests for EgressServiceClient that don't require the Aspire infrastructure.
/// </summary>
public class EgressServiceClientUnitTest
{
    [Fact]
    public async Task Constructor_UsesCustomHttpClient_HeaderIsSent()
    {
        ...
        var service = new EgressServiceClient(
            "http://localhost",
            "key",
